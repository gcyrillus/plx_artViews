...
<p><b>Le fichier stockant les infos de configuration et de stockage</b> est situé dans le repertoire de `data/configuration/plugins` <small>(repertoire commun de configuration des plugins)</small>, ce fichier est désactiver lorsque le plugin est désactiver, <b>ce fichier est supprimé lorsque vous supprimez le plugin</b>. Faites en un backup si vous souhaitez preservé la configuration et comptage des vues.</p>
